          ...
          <div class="card-actions">
            <template v-if="activeSidebarItem !== 'recycle'">
              <el-button
                type="text"
                size="mini"
                :icon="collection.userId === currentUserId || isStarred(collection) ? 'el-icon-star-on' : 'el-icon-star-off'"
                :class="{ starred: collection.userId === currentUserId || isStarred(collection) }"
