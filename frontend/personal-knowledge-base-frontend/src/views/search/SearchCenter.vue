  ...
  <div class="page-wrapper">
    <main class="page-main">
      <div class="page-container">
        <div class="main-search-area" :class="{ 'is-searching': hasSearched }">
          <div class="search-header-bar">
            ...
            <el-button v-if="hasSearched" type="text" @click="handleClear" class="back-btn">
              <i class="fas fa-arrow-left"></i> 返回
            </el-button>
          </div>

          <div v-if="hasSearched" class="tab-bar">
        ...
        <section class="welcome-section">
          <div class="quick-entry">
            <div
              ...
              @click="switchTab('collections', true)"
            >
        ...
        <section class="result-section" v-if="hasSearched && !searchLoading">
          ...
          <div v-else-if="currentResults.length > 0" class="result-list">
            <article v-for="item in currentResults" :key="item.id" class="result-card" @click="handleResultClick(item)">
...
.search-header-bar .main-search-input {
  flex: 1;
}
...
.entry-card.is-active .entry-icon {
  transform: scale(1.1);
